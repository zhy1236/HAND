...
public class PagerSlidingTab extends HorizontalScrollView {
	...
	private int indicatorColor = 0xFF59C2E6;//指示线的颜色#006BCE
	private int underlineColor = 0x00FFFFFF;//底部线可滑动范围背景色
	private int dividerColor = 0x4D333333; //title间的分割线颜色
	...
	private int dividerPadding = 15;//间隔线上下空隙
	private int tabPadding = 0;
	private int dividerWidth = 1;

	private int tabTextSize = 15;//title字体的大小
	private int tabTextColor = 0xFF333333;//未选中字体颜色
	private Typeface tabTypeface = null;
	private int tabTypefaceStyle = Typeface.NORMAL;

	private int lastScrollX = 0;

	private int tabBackgroundResId = R.drawable.background_tab;//点击时背景颜色
	...
	public PagerSlidingTab(Context context, AttributeSet attrs, int defStyle) {
		...
		defaultTabLayoutParams = new LinearLayout.LayoutParams(0, LayoutParams.MATCH_PARENT, 1.0f); //title的大小
...
//			v.setBackgroundResource(tabBackgroundResId); //点击时背景变色
			if (shouldExpand) {
...
//		canvas.drawRect(lineLeft,height/2-indicatorHeight/2, lineRight, height/2+indicatorHeight/2, rectPaint);
	...
	/*	RectF rect = new RectF(lineLeft, 0, lineRight, height);
		...
		canvas.drawRect(50, height - underlineHeight, tabsContainer.getWidth() - 50, height, rectPaint);
